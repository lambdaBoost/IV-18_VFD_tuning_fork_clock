    ...
    if (inputState == LOW) {
      ...
      startTime = millis();
        ...
        pulseTime = millis() - startTime;
          ...
          frequencyScaled = frequency * 1000.0;

          
          digit1 = (frequencyScaled/100000) % 10;
          digit2 = (frequencyScaled/10000) % 10;
          digit3 = (frequencyScaled/1000) % 10;
          digit4 = (frequencyScaled/100) % 10;
          digit5 = (frequencyScaled/10) % 10;
          digit6 = (frequencyScaled) % 10;
          

          displayDigit(digit1,6, false);
          delay(1);
          displayDigit(digit2,5, false);
          delay(1);
          displayDigit(digit3,4, true);
          delay(1);
          displayDigit(digit4,3, false);
          delay(1);
          displayDigit(digit5,2, false);
          delay(1);
          displayDigit(digit6,1, false);
